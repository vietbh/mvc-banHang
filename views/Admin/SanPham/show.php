                            ...
                            <td colspan="17" class="bg-light ">
                                <nav aria-label="Page navigation example ">
                                    <ul class="pagination d-flex justify-content-center mt-4">
                                        ...
                                        <form class="pagination d-flex justify-content-center mt-4" action="<?=ROOT_URL?>admin/sanpham/filter" method="post">
                                            <li class="page-item <?= $pageNum == $start ? 'disabled' : '' ?>">
                                                <input type="text" name="page_n" value="<?= $start ?>" hidden>

                                                <?php if(isset($_SESSION['filter']['ten_sp'])){?>
                                                    <input type="text" name="ten_sp" value="<?=$_SESSION['filter']['ten_sp']?>" hidden>
                                                <?php }?>
                                                <?php if(!empty($_SESSION['filter']['id_loai']) && isset($_SESSION['filter']['id_loai'])){?>
                                                    <input type="text" name="id_loai" value="<?=$_SESSION['filter']['id_loai']?>" hidden>
                                                <?php }?>
                                                <?php if(!empty($_SESSION['filter']['gia_sp']) && isset($_SESSION['filter']['gia_sp'])){?>
                                                    <input type="text" name="gia_sp" value="<?=$_SESSION['filter']['gia_sp']?>"  hidden>
                                                <?php }?>
                                                <?php if(!empty($_SESSION['filter']['gia_min']) && isset($_SESSION['filter']['gia_min'])){?>
                                                        <input type="text" name="gia_min" value="<?=$_SESSION['filter']['gia_min']?>"  hidden>
                                                <?php }?>
                                                <?php if(!empty($_SESSION['filter']['gia_max']) && isset($_SESSION['filter']['gia_max'])){?>
                                                        <input type="text" name="gia_max" value="<?=$_SESSION['filter']['gia_max']?>"  hidden>
                                                <?php }?>
                                                <?php if(!empty($_SESSION['filter']['anhien']) && isset($_SESSION['filter']['anhien'])){?>
                                                        <input type="text" name="anhien" value="<?=$_SESSION['filter']['anhien']?>"  hidden>
                                                <?php }?>
                                                <?php if(!empty($_SESSION['filter']['hot']) && isset($_SESSION['filter']['hot'])){?>
                                                        <input type="text" name="hot" value="<?=$_SESSION['filter']['hot']?>"  hidden>
                                                <?php }?>
                                                <button class="page-link" type="submit"><?=$start?></button>
                                            </li>
                                        </form>
                                        <?php }?>
                                    </ul>
