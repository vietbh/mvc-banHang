...
<body>
  <div class="container-fluid position-relative bg-light m-0 pt-2" style="height: 46.8rem; min-height: min-content;">
    ...
    <div class="position-absolute top-0 start-50 translate-middle-x ">
      <h2 class="fs-4 fw-bold text-center text-dark ">
        <span class="fw-bolder mb-3 p-0" style="font-size: 11rem;">404</span> 
      </h2>
    </div>
