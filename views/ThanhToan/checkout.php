          ...
          <form action="<?= ROOT_URL.'thanhtoan'?>" method="post" class="needs-validation" >
            <div class="row g-3">
              <div class="col-sm">
                ...
                <input type="text" class="form-control" id="firstName" name="hoten" placeholder="" value="" required="">
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="text" class="form-control" id="username" name="phone" placeholder="Phone numbers" required="">
                <div class="invalid-feedback">
                    Your username is required.
                  </div>
                </div>
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="address" name="diachi" placeholder="1234 Main St" required="">
                <div class="invalid-feedback">
